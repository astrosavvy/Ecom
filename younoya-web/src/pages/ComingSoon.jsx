    ...
    <main className="coming-soon">
      ...
      <div className="coming-soon__content">
        ...
        >
          ...
          {/* Sneak Peek Navigation Options */}
          <div className="coming-soon__links">
            <Link to="/shop" className="coming-soon__link">
              <span>Preview 10 Consecrated Brooches</span>
              <ArrowUpRight size={14} />
            </Link>
            <span className="coming-soon__link-divider">•</span>
            <Link to="/find-a-gift" className="coming-soon__link">
              <span>Consult Sanctum Guide</span>
              <ArrowUpRight size={14} />
            </Link>
            <span className="coming-soon__link-divider">•</span>
            <Link to="/blog" className="coming-soon__link">
