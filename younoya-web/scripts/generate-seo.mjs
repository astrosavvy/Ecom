...
function routeHtml(template, route) {
  ...
  const tags = [
    ...
    `<meta property="og:type" content="${seo.product ? 'product' : route.startsWith('/blog/') ? 'article' : 'website'}">`,
    `<meta property="og:title" content="${escapeHtml(seo.title)}">`,
    `<meta property="og:description" content="${escapeHtml(seo.description)}">`,
    `<meta property="og:url" content="${SITE_URL}${route}">`,
    `<meta property="og:image" content="${seo.image.startsWith('http') ? seo.image : `${SITE_URL}${seo.image}`}">`,
