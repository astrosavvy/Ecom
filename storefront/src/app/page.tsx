...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Parallax offset relative to center (-0.5 to 0.5 multiplied by 16px)
    ...
    const updateLoop = () => {
      ...
      // Apply parallax transform to grid
  ...
  return (
    ...
    >
      ...
      {/* ========================================================
          ...
          Clipped to bottom 60% of viewport using inset(40% 0 0 0)
         ======================================================== */}
      <div
        ref={spotlightRef}
      ...
      {/* Bottom Floating Bar / Brand Essence (z-40) */}
