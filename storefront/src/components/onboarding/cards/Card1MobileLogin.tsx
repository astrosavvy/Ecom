    ...
    <div className="w-full flex flex-col justify-between h-full p-6 sm:p-8 select-none text-left">
      ...
      <div className="space-y-2">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#D4AF37]/10 border border-[#D4AF37]/30 text-[#D4AF37] text-[10px] font-mono uppercase tracking-wider">
          ...
          <span>VEDIC ASTRAL ONBOARDING // STEP 01</span>
        </div>
        ...
        <p className="text-xs sm:text-sm text-stone-300 leading-relaxed">
          Enter your mobile number to begin astral chart synchronization and receive a secure instant authentication pass.
        </p>
      </div>
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative flex items-center">
            ...
            <input
              ...
              className="w-full pl-24 pr-4 py-3.5 rounded-2xl bg-white/5 border border-white/10 text-white font-mono text-sm tracking-widest placeholder-stone-500 focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all"
            />
          </div>
      ...
      {/* Footer Assurance */}
      <div className="pt-3 border-t border-white/10 flex items-center gap-2 text-[10px] text-stone-400 font-mono">
