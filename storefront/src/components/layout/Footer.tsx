...
export function Footer() {
  return (
    <footer className="w-full bg-[#0a0a0c] text-white/70 font-inter border-t border-white/10 relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-12 py-16 grid grid-cols-1 md:grid-cols-12 gap-10 relative z-10">
        {/* Brand & Purpose */}
        ...
        <div className="md:col-span-2 space-y-3">
          ...
          <ul className="space-y-2 text-xs text-white/60 list-none p-0 m-0">
            ...
            <li><Link href="/search" className="hover:text-white transition-colors">Vedic Rakhis</Link></li>
            <li><Link href="/blog" className="hover:text-white transition-colors">Journal</Link></li>
            <li><Link href="/contact" className="hover:text-white transition-colors">Consultations</Link></li>
          </ul>
        </div>
        ...
        <div className="md:col-span-2 space-y-3">
          ...
          <ul className="space-y-2 text-xs text-white/60 list-none p-0 m-0">
            <li><Link href="/shipping" className="hover:text-white transition-colors">Express Delivery</Link></li>
            <li><Link href="/refund" className="hover:text-white transition-colors">Returns & Unboxing</Link></li>
            <li><Link href="/terms" className="hover:text-white transition-colors">Terms of Grace</Link></li>
        ...
        <div className="md:col-span-3 space-y-3">
          ...
          <div className="space-y-2 text-xs text-white/60">
            ...
            <div className="pt-2">
              <Link
                href="/checkout"
                className="inline-block liquid-glass text-white px-5 py-2.5 rounded-full text-xs font-medium hover:bg-white/5 transition-colors"
              >
                Begin Now →
              </Link>
            </div>
